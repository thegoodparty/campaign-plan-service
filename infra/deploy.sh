...
pulumi stack select "organization/campaign-plan-service/campaign-plan-service-$env" --create
...
pulumi config set --path aws:defaultTags.tags.Project campaign-plan-service
